        ...
        >
          ...
          <div className="border-b border-neutral-800 mb-6">
            <nav className="flex -mb-px">
              <button
                type="button"
                className={`mr-6 py-3 border-b-2 font-medium transition-colors ${
                  activeTab === FormTab.AUTO
                    ? "border-[#2fd345] text-[#2fd345]"
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4">
                  <input
                    ...
                    placeholder="Enter a concept like 'a halloween token about arnold schwarzenegger'"
                    className="flex-1 bg-[#0F0F0F] py-2.5 px-3 border border-neutral-800 text-white"
                  />
                  <button
                    type="button"
